...
# Assuming pathmodels and added_model_with_two are dictionaries
# for digit in pathmodels.keys():
#     if digit in added_model_with_two and (0.5, 0.5) in added_model_with_two[digit]:
#         models1 = pathmodels[digit]
#         models2 = added_model_with_two[digit][(0.5, 0.5)]

#         # Assuming models1 and models2 are instances of VariationalAutoEncoder
#         identical = True
#         for p1, p2 in zip(models1.parameters(), models2.parameters()):
...
#     else:
#         print(f"Digit {digit} not found in added_model_with_two or missing key (0.5, 0.5).")
